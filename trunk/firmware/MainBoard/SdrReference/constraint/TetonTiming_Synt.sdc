...
define_clock   {atck} -name {atck}  -freq 20 -clockgroup external_jtaggruop

#define_clock 	{XTLOSC} -name { XTLOSC } -period 50.000 -waveform { 0.000 25.000  }  { Teton_MSS_0/MSS_CCC_0/I_XTLOSC:CLKOUT  } 
