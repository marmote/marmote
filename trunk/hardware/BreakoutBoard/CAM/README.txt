BreakoutBoard (Smoky) Revision B
...
PCB STACKUP:
	...
	3 (Inner 2)		Positive		Inner (signal)
	16 (Bottom)		Positive		Solder side (GND)
...
BreakoutBoard.GP1 - Inner Layer 1, Positive Polarity
BreakoutBoard.GP2 - Inner Layer 2, Positive Polarity
