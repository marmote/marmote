...
entity CIC_mem is 
    port( DINA : in std_logic_vector(37 downto 0); DOUTA : out 
        ...
        std_logic_vector(2 downto 0); ADDRB : in 
        std_logic_vector(2 downto 0);RWA, RWB, BLKA, BLKB, CLKAB, 
        RESET : in std_logic) ;
end CIC_mem;


architecture DEF_ARCH of  CIC_mem is
    ...
    CIC_mem_R0C3 : RAM4K9
      port map(ADDRA11 => GND_1_net, ADDRA10 => GND_1_net, 
        ...
        GND_1_net, ADDRB3 => GND_1_net, ADDRB2 => ADDRB(2), 
...
-- MGNTIMER:F
-- MGNCMPL:T
-- DESDIR:D:/Work/marmote/projects/CIC_FABRIC_SRAM/smartgen\CIC_mem
-- GEN_BEHV_MODULE:T
